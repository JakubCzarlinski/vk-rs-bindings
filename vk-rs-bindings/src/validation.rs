...
#[cfg(
    all(feature = "VK_KHR_video_encode_h264", not(feature = "VK_KHR_video_encode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_encode_h265", not(feature = "VK_KHR_video_encode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_decode_h264", not(feature = "VK_KHR_video_decode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_GGP_stream_descriptor_surface", not(feature = "VK_KHR_surface"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_NV_external_memory_win32", not(feature = "VK_NV_external_memory"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_device_group", not(feature = "VK_KHR_device_group_creation"))
)]
compile_error!(
...
#[cfg(all(feature = "VK_KHR_incremental_present", not(feature = "VK_KHR_swapchain")))]
compile_error!(
...
#[cfg(all(feature = "VK_EXT_direct_mode_display", not(feature = "VK_KHR_display")))]
compile_error!(
...
#[cfg(all(feature = "VK_EXT_display_surface_counter", not(feature = "VK_KHR_display")))]
compile_error!(
...
#[cfg(
    all(
        ...
        not(
            all(feature = "VK_EXT_display_surface_counter", feature = "VK_KHR_swapchain")
        )
    )
)]
compile_error!(
...
#[cfg(all(feature = "VK_GOOGLE_display_timing", not(feature = "VK_KHR_swapchain")))]
compile_error!(
...
#[cfg(all(feature = "VK_EXT_swapchain_colorspace", not(feature = "VK_KHR_surface")))]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_external_fence_win32", not(feature = "VK_KHR_external_fence"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_get_surface_capabilities2", not(feature = "VK_KHR_surface"))
)]
compile_error!(
...
#[cfg(all(feature = "VK_KHR_get_display_properties2", not(feature = "VK_KHR_display")))]
compile_error!(
...
#[cfg(
    all(
        ...
        not(any(feature = "VK_KHR_get_memory_requirements2", feature = "VK_VERSION_1_1"))
    )
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_decode_h265", not(feature = "VK_KHR_video_decode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_NV_shader_subgroup_partitioned", not(feature = "VK_VERSION_1_1"))
)]
compile_error!(
...
#[cfg(all(feature = "VK_FUCHSIA_imagepipe_surface", not(feature = "VK_KHR_surface")))]
compile_error!(
...
#[cfg(all(feature = "VK_EXT_subgroup_size_control", not(feature = "VK_VERSION_1_1")))]
compile_error!(
...
#[cfg(
    all(
        ...
        not(
            all(feature = "VK_VERSION_1_1", feature = "VK_KHR_get_surface_capabilities2")
        )
    )
)]
compile_error!(
...
#[cfg(
    all(
        ...
        not(any(feature = "VK_KHR_sampler_ycbcr_conversion", feature = "VK_VERSION_1_1"))
    )
)]
compile_error!(
...
#[cfg(
    all(
        ...
        not(
            all(feature = "VK_KHR_surface", feature = "VK_KHR_get_surface_capabilities2")
        )
    )
)]
compile_error!(
...
#[cfg(all(feature = "VK_QCOM_tile_shading", not(feature = "VK_QCOM_tile_properties")))]
compile_error!(
...
#[cfg(all(feature = "VK_NV_external_memory_sci_buf", not(feature = "VK_VERSION_1_1")))]
compile_error!(
...
#[cfg(all(feature = "VK_ARM_shader_core_properties", not(feature = "VK_VERSION_1_1")))]
compile_error!(
...
#[cfg(all(feature = "VK_GOOGLE_surfaceless_query", not(feature = "VK_KHR_surface")))]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_shader_maximal_reconvergence", not(feature = "VK_VERSION_1_1"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_decode_av1", not(feature = "VK_KHR_video_decode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_encode_av1", not(feature = "VK_KHR_video_encode_queue"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_KHR_video_decode_vp9", not(feature = "VK_KHR_video_decode_queue"))
)]
compile_error!(
...
#[cfg(all(feature = "VK_KHR_video_maintenance1", not(feature = "VK_KHR_video_queue")))]
compile_error!(
...
#[cfg(
    all(feature = "VK_QCOM_image_processing2", not(feature = "VK_QCOM_image_processing"))
)]
compile_error!(
...
#[cfg(
    all(feature = "VK_QCOM_filter_cubic_weights", not(feature = "VK_EXT_filter_cubic"))
)]
compile_error!(
...
#[cfg(all(feature = "VK_KHR_video_maintenance2", not(feature = "VK_KHR_video_queue")))]
compile_error!(
...
#[cfg(all(feature = "VK_QCOM_data_graph_model", not(feature = "VK_ARM_data_graph")))]
compile_error!(
